...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","Exp","Seq","Cond","Uri","Lit","Number","File","Bool","'('","';'","')'","'<'","'>'","'<='","'>='","'='","NOT","','","int","lit","TRUE","FALSE","PRINT","WHERE","UNION","PRED","SUB","OBJ","AND","OR","FROM","ADD","DELETE","RESTRICT","GET","URI","file","%eof"]
